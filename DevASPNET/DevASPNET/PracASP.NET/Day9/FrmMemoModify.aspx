<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="FrmMemoModify.aspx.cs" Inherits="DevASPNET.PracASP.NET.Day9.FrmMemoModify" %>
...
<body>
    <form id="form1" runat="server">
        <div>
            <h3>데이터 수정</h3>
            번호 : <asp:TextBox ID="txtNum" runat="server"></asp:TextBox><br />
