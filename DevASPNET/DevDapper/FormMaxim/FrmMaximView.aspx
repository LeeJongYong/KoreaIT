<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="FrmMaximView.aspx.cs" Inherits="DevDapper.FormMaxim.FrmMaximView" %>
...
<body>
    <form id="form1" runat="server">
        <div>
            ...
            <asp:HyperLink ID="btnList" runat="server" NavigateUrl="~/FormMaxim/FrmMaximList.aspx">리스트</asp:HyperLink>
        </div>
    </form>
</body>
</html>
